...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('xru','RP325552475CN',$extraInfo);
...
//$track = $track->getSingleTrackingResult("xru","RP325552475CN",'en');
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('xru','RP325552475CN',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('xru','RP325552475CN');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("xru","RP325552475CN",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("RP325552475CN","xru","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"RP325552475CN","carrier_code"=>"xru");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"xru");
